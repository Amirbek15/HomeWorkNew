...
int Promt (string message)
{
 ...
 if (result == 0)
 {
  System.Console.WriteLine("Вы указали недостаточный размер массива!");
  return -1;
 }
 return result;
}
...
int CountEvenNumbers (int [] ArrayIn)
{
 int count = 0;
...
int sizeArray = Promt ("Введите трехзначный размер массива: ");
int [] newArray = FillDigitPositiveArray(sizeArray);
System.Console.WriteLine(string.Join("; ", newArray));
System.Console.WriteLine($"Количество четных чисел равно: {CountEvenNumbers(newArray)}");
